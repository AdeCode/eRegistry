<?php
    ...
    $sql = "INSERT INTO users (id, email, Staff_id, password, fullname, sex, phone,role,status,photo,date_created,created_by) 
                VALUES (null, '$email', '$staff_id', '$password', '$fullname', '$sex','$phone','$role','$status','$photo',' $dateCreated ','$createdBy')";
...
<section class="w3-row">
    ...
    <div class="w3-col l4">
        <div class="w3-margin w3-border w3-round-large w3-border-orange w3-text-dark-gray" style="min-height: 200px;"> 
            ...
            <form class="w3-container" action="index.php?pg=s5" method="post"> 
                <input class="w3-input" type="email" placeholder="email" name="email" id="email" required="required" autocomplete="off">
				<input class="w3-input" type="staffId" placeholder="staffId" name="staffId" id="staffId" required="required" autocomplete="off">
