              ...
              <div class="col-md-12">
                ...
                <?php
                    $departmentName = "";
                        ...
                        $record = DiffTables::find_by_sql("SELECT * FROM department WHERE StdepartmentNameaff_id='$deptName' LIMIT 1");
                ...
                ?>        
                  ...
                  <div class="form" id="form">
                  <form action="index.php?pg=d2" method="post" role="form" class="myForm" name="myForm" >    
